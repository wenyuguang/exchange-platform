    	                ...
    	                success:function(data){//定义交互完成，并且服务器正确返回数据时调用的回调函数  
    	                	/* var data = '<RESOURCE>
    	                		 ' <BRIEF>'+
    	                	        ...
    	                	        '</BRIEF>'+
    	                	    ' <info>'+
    	                	    '<cysj>1995-07-10 00:00:00.0</cysj>'+
    	                	        '<lsmc>北京大成律师事务所</lsmc>'+
    	                	        '<lszyxkzh>11101200110618601</lszyxkzh>'+
    	                	        '<lszyzgzh>139573060226</lszyzgzh>'+
    	                	        '<sfzhm>132435197306261516</sfzhm>'+
    	                	        '<sjh>13911185886</sjh>'+
    	                	        '<xb>1</xb>'+
    	                	        '<xm>阴颖晖</xm>'+
    	                	        '<zgzqdrq>1995-09-25</zgzqdrq>'+
    	                	        '<zyzqdrq>1995-07-10</zyzqdrq>'+
    	                	        '<zyzt>1</zyzt>'+
    	                	        '<fjml>'+
    	                	        '<zgz>/file/20160216/F1FD375F46F391A0B0ADD97F01C69B6F</zgz>'+
    	                	            '<zyz>/file/20160216/260B152EFE8F244F43576BA1809F442E</zyz>'+
    	                	        '</fjml>'+
    	                	    '</info>'+
    	                	'</RESOURCE>'*/
